...
tag_countries = {
    ...
    'ENG': ['united kingdom', 'uk', 'великобритания', 'вб'],
    'SOV': ['soviet union', 'soviet', 'советский союз', 'совок'],
    'SWE': ['sweden', 'швеция'],
    'FRA': ['france', 'free_france', 'франция', 'свободная франция'],
    'LUX': ['luxemburg', 'люксембург'],
    'BEL': ['belgium', 'бельгия'],
    'HOL': ['holland', 'netherlands', 'нидерланды', 'голландия'],
    ...
    'NZL': ['new_zealand', 'новая зеландия'],
    'PAN': ['panama', 'панама'],
    'PER': ['persia', 'иран'],
    'PHI': ['philippines', 'филиппины'],
    'PRU': ['peru', 'перу'],
    'SAF': ['south_africa', 'южная африка'],
...
with open('tag_countries.json', 'w', encoding="UTF-8") as json_file:
    json.dump(tag_countries, json_file, indent=4, ensure_ascii=False)